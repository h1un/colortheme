        ...
        <Card>
            ...
            <CardContent>
                <div className="grid grid-cols-3 gap-4">
                    ...
                    >
                        <CreditCard className={`h-6 w-6 transition-colors duration-300 ease-in-out ${activeMethod === 'card' ? 'text-primary' : ''}`} />
                        <span>카드</span>
                    </Button>
                    <Button
                        variant="outline"
                    ...
                    >
                        <svg className={`h-6 w-6 transition-colors duration-300 ease-in-out ${activeMethod === 'paypal' ? 'text-primary' : ''}`} viewBox="0 0 24 24" fill="currentColor">
                    ...
                    >
                        <Apple className={`h-6 w-6 transition-colors duration-300 ease-in-out ${activeMethod === 'apple' ? 'text-primary' : ''}`} />
                        <span>Apple</span>
                    </Button>
                </div>
            </CardContent>
